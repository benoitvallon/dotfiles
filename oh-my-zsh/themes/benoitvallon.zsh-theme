# This theme is based on "wedisagree"
...
PROMPT=$'%{$fg_bold[cyan]%}%n%{$reset_color%}%{$fg_bold[white]%}@%{$reset_color%}%{$fg_bold[blue]%}%m%{$reset_color%}%{$fg_bold[white]%}:%{$reset_color%}%{$fg_bold[magenta]%}%d %{$reset_color%}
$ '
